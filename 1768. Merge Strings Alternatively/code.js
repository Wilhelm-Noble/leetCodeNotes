...
var mergeAlternately = function(word1, word2) {
    result = '';
    //find the total numder of chars for words so you have the loop value
    maxLength = Math.max(word1.length, word2.length);

    for(let i = 0; i < maxLength; i++){
       /*simply dicates that as long as there is a value it will
       push the values into result alternatively*/
